...
function pintaUsuarios(res) {
    ...
    $('.usuarios_int').empty();
    // $('.usuarios_int').append('<div class="mdl-spinner mdl-spinner--single-color mdl-js-spinner is-active"></div>');
...
function activaSecSesiones() {
    //TODO reportes por perfil
    // if (elPerfil === "Instructor") {
    //     $("#reportesSesiones").removeClass("mdl-grid").empty();
    // }
    if (elPerfil === "Instructor") {
        $('#botonReportesSesiones1').next().remove();
        $('#botonReportesSesiones1').next().remove();
        $('#botonReportesSesiones1').remove();
        $('#botonReportesSesiones2').next().remove();
        $('#botonReportesSesiones2').next().remove();
        $('#botonReportesSesiones2').remove();
...
function obtenerDuracionX() {
    moment.locale('es');
    fechaInicialX = '2016-12-22 13:03:24';
    laFechaFinalX = moment().format();
    laDuracion = moment(fechaInicialX).fromNow(true);

    console.log('------------------------------------');
    console.log('fechaInicialX', fechaInicialX);
    console.log('laFechaFinalX', laFechaFinalX);
    console.log('laDuracionX', laDuracion);
    console.log('------------------------------------');
